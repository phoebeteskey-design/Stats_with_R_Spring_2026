...
str(birds)
ggplot(birds, aes(x = species, y= abundance))+
  geom_col()+
  coord_flip()
```


b)	Calculate the median and the mean. In this particular case, which do you think is the best measure of center, the mean or the median? Why?
