...
#Reference group cannot be identified?


summary(weight_gain_mice)

# library(tidyverse)
# growth_1 <- growth %>% 
#   unite("combo", supplement, diet, sep = "_")
# 
# combo_plot <- ggplot(growth_1, aes(x = gain, y = combo))+
#   geom_point()
# combo_plot

color_plot <- ggplot(growth, aes(x = gain, y = supplement, color = diet))+
  geom_point()
color_plot
```
